...
import com.ibm.model.RetrievePaymentMechanismResponsePaymentMechanism;
...
public class RetrievePaymentExecutionWorkstepResponse {
  ...
  */
  @Valid 
  @Schema(name = "PaymentExecutionWorkstep", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
