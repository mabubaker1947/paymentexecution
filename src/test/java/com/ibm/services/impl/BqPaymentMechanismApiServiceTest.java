...
mvc.perform(MockMvcRequestBuilders.get("/PaymentExecution/{paymentexecutionid}/PaymentMechanism/{paymentmechanismid}/Retrieve",1,1)                 .headers(httpHeaders).param("paymentexecutionid", "test").param("paymentmechanismid", "test")
